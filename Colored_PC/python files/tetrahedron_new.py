...
ground_truth_path = '/home/hari/Desktop/pcd/BlenderToolbox/test/gamma_noise/gt/Tetrahedron_clean.xyz'
noisy_path = '/home/hari/Desktop/pcd/BlenderToolbox/test/230.05_Tetrahedron_gamma_1.5modified.xyz'
outputPath = os.path.abspath('./tet_score.png')
...
location = (-0.678833, 0.532783, 0.189966)
rotation = (637.646, -187.271, -353.338)
scale = (0.5, 0.5, 0.5)
...
# Save Blender file
bpy.ops.wm.save_mainfile(filepath=os.getcwd() + '/tet_score.blend')
