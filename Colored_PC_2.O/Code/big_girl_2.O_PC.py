...
# Define paths
directory_path = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Point_cloud\big_girl_2.O_PC'
ground_truth_filename = r'big_girl.xyz'
ground_truth_path = os.path.join(directory_path, ground_truth_filename)
output_dir = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Output_PC_Vis\big_Girl_2.O_output'
