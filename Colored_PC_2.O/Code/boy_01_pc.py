...
# Define paths
directory_path = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Point_cloud\boy_01_PC'
ground_truth_filename = r'boy01.xyz'
ground_truth_path = os.path.join(directory_path, ground_truth_filename)
output_dir = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Output_PC_Vis\boy_01_output'
