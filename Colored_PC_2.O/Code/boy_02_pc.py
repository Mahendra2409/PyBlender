...
# Define paths
directory_path = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Point_cloud\boy_02_PC'
ground_truth_filename = r'boy02.xyz'
ground_truth_path = os.path.join(directory_path, ground_truth_filename)
output_dir = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Output_PC_Vis\boy_02_output'
