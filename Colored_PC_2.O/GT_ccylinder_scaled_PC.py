...
location = (-0.370186, -5.31554, -2.55748)
rotation = (448.706, -0.984887, -94.562)
scale = (3.71272, 3.71272, 3.71272)
...
blend_file_name = f"{os.path.splitext(os.path.basename(outputPath))[0]}.blend"
