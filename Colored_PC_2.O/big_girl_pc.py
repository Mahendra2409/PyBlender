...
# # Define paths
# directory_path = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Point_cloud(.xyz)\Big_girl_PC'
# ground_truth_filename = r'big_girl.xyz'
# ground_truth_path = os.path.join(directory_path, ground_truth_filename)
# output_dir = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Output_PC_Vis\Big_Girl_output'
...
directory_path = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Point_cloud(.xyz)", "Big_girl_PC")
ground_truth_filename = r'big_girl.xyz'
ground_truth_path = os.path.join(directory_path, ground_truth_filename)
output_dir = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Output_PC_Vis", "Big_Girl_output")
