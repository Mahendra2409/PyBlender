...
ground_truth_path = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Cube\cube_pyramid_hole_clean.xyz'
noisy_path = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Cube\dmr_cube_pyramid_hole_gaussian_diagonal_0.5.xyz'
outputPath = r'M:\Order to PC\CAD_Reconstruction\Blender\Colored_PC_2.O\Output_PC_Vis\Cube_Output'
...
# Save Blender file
bpy.ops.wm.save_mainfile(filepath=os.getcwd() + '/star_score.blend')
