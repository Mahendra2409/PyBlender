...
directory_path = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Point_cloud(.xyz)", "boy_02_PC_v2")
ground_truth_filename = r'boy02.xyz'
ground_truth_path = os.path.join(directory_path, ground_truth_filename)
output_dir = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Output_PC_Vis", "boy_02_output")
...
for filename in os.listdir(directory_path):
    ...
    if filename.endswith(".xyz") and filename != ground_truth_filename:
        ...
        location = (6.63596, -6.13761, -2.19029)
