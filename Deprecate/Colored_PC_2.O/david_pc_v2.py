...
directory_path = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Point_cloud(.xyz)", "david_PC_v2")
ground_truth_filename = r'david.xyz'
ground_truth_path = os.path.join(directory_path, ground_truth_filename)
output_dir = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Output_PC_Vis", "david_output_v2")
...
for filename in os.listdir(directory_path):
    ...
    if filename.endswith(".xyz") and filename != ground_truth_filename:
        ...
        location = (6.15212, -8.1798, -1.15163)
        rotation = (92.8616, -6.26444, 50.2207)
