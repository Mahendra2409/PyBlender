...
directory_path = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Point_cloud(.xyz)", "Duck_PC")
ground_truth_filename = r'duck.xyz'
ground_truth_path = os.path.join(directory_path, ground_truth_filename)
output_dir = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Output_PC_Vis", "Duck_output")
