...
directory_path = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Point_cloud(.xyz)", "Girl_PC")
ground_truth_filename = r'girl.xyz'
ground_truth_path = os.path.join(directory_path, ground_truth_filename)
output_dir = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Output_PC_Vis", "Girl_output")
...
for filename in os.listdir(directory_path):
    ...
    if filename.endswith(".xyz") and filename != ground_truth_filename:
        ...
        location = (4.41426,-9.74691, -1.49492)
        rotation = (93.3421, -14.3491, -323.647)
        ...
        ptSize = 1.0  # Reduce point size for better visibility
