...
directory_path = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Point_cloud(.xyz)", "oct_fixed_PC")
ground_truth_filename = r'Octahedron.xyz'
ground_truth_path = os.path.join(directory_path, ground_truth_filename)
output_dir = os.path.join(project_root_cwd, "Data", "data.xyz(Colored_PC_2.O)", "Output_PC_Vis", "oct_fixed_PC")
...
for filename in os.listdir(directory_path):
    ...
    if filename.endswith(".xyz") and filename != ground_truth_filename:
        ...
        # location = (0.315183, 0.028547, 0.66579)
        # rotation = (79.8279, -8.10415, 77.9874)
        # scale = (1.0, 1.0, 1.0)
        location = (0.315183, 0.028547, 0.66579)
        rotation = (156.633, -1.1486, 88.7233)
        scale = (0.806525, 0.806525, 0.806525)
        ...
        ptSize = 0.009  # Reduce point size for better visibility
